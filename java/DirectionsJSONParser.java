...
public class DirectionsJSONParser {
    ...
    //TODO: add a getAddress function later

    private double totalLength, travelDuration;
        ...
        try {
            ...
            for(int i=0;i<jRoutes.length();i++){
                ...
                for(int j=0;j<jLegs.length();j++){
                    totalLength+=((JSONObject)((JSONObject)jLegs.get(j)).get("distance")).getDouble("value");
                    travelDuration+=((JSONObject)((JSONObject)jLegs.get(j)).get("duration")).getDouble("value");
